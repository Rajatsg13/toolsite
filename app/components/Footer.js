      ...
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            ...
            <li><Link href="/pdf-split"     className="hover:text-white transition-colors">PDF Split</Link></li>
        ...
        <div>
          <h4 className="font-semibold text-white mb-3 text-sm uppercase tracking-wide">Image Tools</h4>
          <ul className="space-y-2 text-sm">
            <li><Link href="/image-to-pdf"  className="hover:text-white transition-colors">Image to PDF</Link></li>
            <li><Link href="/image-resize"  className="hover:text-white transition-colors">Image Resizer</Link></li>
          </ul>
          <h4 className="font-semibold text-white mt-6 mb-3 text-sm uppercase tracking-wide">Calculators</h4>
          <ul className="space-y-2 text-sm">
